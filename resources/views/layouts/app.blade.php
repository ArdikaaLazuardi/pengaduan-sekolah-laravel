...
<body class="{{ $isGuestPage ? 'auth-page-body' : 'app-page-body' }}">
            ...
            @if(session('success'))
                <div class="app-toast app-toast-success auto-dismiss-toast">
                    ...
                    <div class="app-toast-body">
                        ...
                        <div class="app-toast-text">{{ session('success') }}</div>
                    </div>
                </div>
            @endif
            ...
            @if(session('error'))
                <div class="app-toast app-toast-error auto-dismiss-toast">
                    ...
                    <div class="app-toast-body">
                        ...
                        <div class="app-toast-text">{{ session('error') }}</div>
                    </div>
                </div>
            @endif
        </div>
                    ...
                    <aside class="dashboard-sidebar">
                        ...
                        <nav class="sidebar-menu">
                            @if($isSiswa)
                                ...
                                <a href="{{ route('siswa.aspirasi.create') }}" class="sidebar-link {{ request()->routeIs('siswa.aspirasi.create') ? 'active' : '' }}">
                                    <i class="bi bi-plus-square"></i>
                                    Input Aspirasi
                                </a>

                                <a href="{{ route('siswa.aspirasi.index') }}#daftar-aspirasi" class="sidebar-link {{ request()->routeIs('siswa.aspirasi.index') || request()->routeIs('siswa.aspirasi.show') || request()->routeIs('siswa.aspirasi.edit') ? 'active' : '' }}">
                            ...
                            @elseif($isAdmin)
                                ...
                                <a href="{{ route('admin.aspirasi.index') }}#daftar-aspirasi-admin" class="sidebar-link {{ request()->routeIs('admin.aspirasi.index') || request()->routeIs('admin.aspirasi.show') || request()->routeIs('admin.aspirasi.edit') ? 'active' : '' }}">
                        ...
                        <div class="sidebar-bottom-card">
                            ...
                            @if($isSiswa)
                                <a href="{{ route('siswa.aspirasi.create') }}" class="mini-btn">
                                    <i class="bi bi-send"></i>
                                    Buat Aspirasi
                                </a>
                            @else
                                <a href="{{ route('admin.aspirasi.index') }}#daftar-aspirasi-admin" class="mini-btn">
