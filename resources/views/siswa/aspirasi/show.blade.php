...
<div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        @if($aspirasi->status === 'Menunggu')
            <a href="{{ route('siswa.aspirasi.edit', $aspirasi) }}" class="btn btn-primary">
        ...
        <div class="card-soft p-4 h-100" style="background: linear-gradient(145deg, #0f4f4b 0%, #0b3d3a 100%); color: #fff;">
            ...
            <div class="mt-4">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    @if($aspirasi->status === 'Menunggu')
                        <a href="{{ route('siswa.aspirasi.edit', $aspirasi) }}" class="btn btn-outline-light btn-sm px-3 rounded-pill fw-bold">
