        ...
        <div class="card-soft p-4 h-100">
            ...
            <div class="d-flex align-items-end justify-content-between">
                <div>
                    ...
                    <div class="small mt-2" style="color: var(--text-soft);"><?php echo e($donePercent); ?>% sudah tuntas</div>
                </div>
        ...
        <div class="card-soft p-4 h-100" style="background: linear-gradient(145deg, #0f4f4b 0%, #0b3d3a 100%); color: #fff;">
            <div class="d-flex justify-content-between align-items-start mb-4">
                <div>
                    ...
                    <div style="font-size:2rem; font-weight:800; line-height:1.1;">
                        <?php echo e(auth('admin')->user()->username); ?>
            ...
            <div class="rounded-4 p-3 mb-3" style="background: rgba(255,255,255,.09); border:1px solid rgba(255,255,255,.10);">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div style="font-size:1.8rem; font-weight:800;"><?php echo e($activeFilterCount); ?></div>
            ...
            <?php if($latestAspirasi): ?>
                <div class="rounded-4 p-3" style="background: rgba(255,255,255,.09); border:1px solid rgba(255,255,255,.10);">
                    ...
                    <div class="fw-bold"><?php echo e($latestAspirasi->siswa->nama); ?></div>
                    <div class="small text-white-50 mt-1">
                        <?php echo e($latestAspirasi->kategori->ket_kategori); ?> • <?php echo e($latestAspirasi->lokasi); ?>
            ...
            <div class="mt-4">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('admin.aspirasi.index')); ?>" class="btn btn-light btn-sm px-3 rounded-pill fw-bold">
                        <i class="bi bi-funnel me-1"></i>
                        Filter Data
                    </a>
                    <a href="<?php echo e(route('admin.aspirasi.index')); ?>#daftar-aspirasi-admin" class="btn btn-outline-light btn-sm px-3 rounded-pill fw-bold">
            ...
            <div class="mt-4 p-3 rounded-4" style="background:#f6f3ee; border:1px solid var(--border-soft);">
                <div class="d-flex flex-column flex-lg-row justify-content-between gap-3">
                    ...
                    <div class="text-lg-end">
                        ...
                        <div style="font-size:1.6rem; font-weight:800; line-height:1;"><?php echo e($activeFilterCount); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="card-soft p-0 overflow-hidden" id="daftar-aspirasi-admin">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 p-4 border-bottom" style="border-color: var(--border-soft) !important;">
        ...
        <div class="topbar-chip">
            ...
            <?php echo e($aspirasis->total()); ?> data
        </div>
    </div>
        ...
        <div class="d-block d-xl-none p-3 border-bottom" style="border-color: var(--border-soft) !important;">
            <div class="card-soft p-3 shadow-none border">
                <div class="d-flex justify-content-between gap-3 mb-2">
                    <div>
                        <div class="fw-bold"><?php echo e($aspirasi->siswa->nama); ?></div>
                        <div class="small" style="color: var(--text-soft);">
                ...
                <div class="small mb-2" style="color:#4b5563;">
                    <strong><?php echo e($aspirasi->kategori->ket_kategori); ?></strong> • <?php echo e($aspirasi->lokasi); ?>

                </div>

                <div class="small mb-2" style="color:#4b5563;">
                    <?php echo e(\Illuminate\Support\Str::limit($aspirasi->ket, 110)); ?>

                </div>

                <div class="small mb-2" style="color: var(--text-soft);">
                    Tanggal: <?php echo e($aspirasi->created_at->format('d/m/Y')); ?>
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('admin.aspirasi.show', $aspirasi)); ?>" class="btn btn-soft btn-sm">
                        <i class="bi bi-eye me-1"></i>
                        Detail
                    </a>

                    <a href="<?php echo e(route('admin.aspirasi.edit', $aspirasi)); ?>" class="btn btn-primary btn-sm">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $aspirasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aspirasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td style="min-width: 280px;"><?php echo e(\Illuminate\Support\Str::limit($aspirasi->ket, 80)); ?></td>
                        <td>
                            <span class="status-pill <?php echo e($statusClass($aspirasi->status)); ?>">
                                <?php echo e($aspirasi->status); ?>
